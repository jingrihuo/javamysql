...
public class FrmApplyCartype extends JDialog implements ActionListener {
	...
	private JTextField edtCartypenum = new JTextField(20);
	private JTextField edtCartypename = new JTextField(20);
	private JTextField edtCartypeintroduce = new JTextField(20);

	private Font font = new Font("宋体", Font.BOLD, 18);

	public FrmApplyCartype() {
		super();
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.btnCancel) {
			...
			try {
				...
				SummerWorkUtil.cartypeManager.addCartype(Cartype);
