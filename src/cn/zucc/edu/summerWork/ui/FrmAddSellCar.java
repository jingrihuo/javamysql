...
public class FrmAddSellCar extends JDialog implements ActionListener {
	private boolean Sell = false;
	public Beanusercar SellCar;
	...
	public FrmAddSellCar() throws BaseException {
		super();
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == this.btnOk) {
			...
			if (JOptionPane.showConfirmDialog(this, "确定以" + price + "元出售此车嘛？", "确认",
				...
				Beansellcar UserSellcar = new Beansellcar();
				UserSellcar.setUsername(Beanuser.LoginUser.getUsername());
				UserSellcar.setCarnum(SellCar.getCarnum());
				UserSellcar.setSellprice(price);
				UserSellcar.setSelldate((Date) DateCarSellDate.getValue());
				UserSellcar.setSellway(SellwayState.getSelectedItem().toString());
				UserSellcar.setSelltype("上架");
				try {
					SummerWorkUtil.sellcarManager.AddSellCar(UserSellcar);
